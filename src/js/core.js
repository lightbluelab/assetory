...
async function loadGuide(){
  ...
  if(!target) return;
  const downloads=`<p><a href="./README.md?v=20260803-v26" download="README.md">下载 README</a>　<a href="./PROJECT_CONTEXT.md?v=20260803-v26" download="PROJECT_CONTEXT.md">下载 Project Context</a></p>`;
  ...
  try{
    const response=await fetch("./README.md?v=20260803-v26",{cache:"no-store"});
